...
export const metadata: Metadata = {
  title: "Alessandro Noya - Student Athlete & Future Pilot",
  description: "Portfolio of Alessandro Noya: Torrey Pines High School junior, volleyball champion, chess prodigy, and aspiring pilot with international background from Brazil, Italy, and USA.",
  keywords: ["Alessandro Noya", "Torrey Pines High School", "volleyball player", "chess prodigy", "pilot license", "student athlete", "international student"],
  metadataBase: new URL("https://alessandronoya.com"),
  alternates: {
    canonical: "https://alessandronoya.com"
  },
  openGraph: {
    title: "Alessandro Noya - Student Athlete & Future Pilot",
    description: "Portfolio showcasing excellence in academics, volleyball, chess, and aviation from Rio to Rome to San Diego",
    siteName: "Alessandro Noya Portfolio",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763227150743-je35ql51.jpg",
      alt: "Alessandro Noya volleyball action"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Alessandro Noya - Student Athlete & Future Pilot",
    description: "Excellence in academics, volleyball, chess, and aviation",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763227150743-je35ql51.jpg"]
  },
  robots: {
    index: true,
    follow: true
